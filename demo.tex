...
\title{面向碳纳米管阵列的知识增强智能分析与形貌预测方法研究}
\entitle{Research on Knowledge-Enhanced Intelligent Analysis and Morphology Prediction Methods for Carbon Nanotube Arrays}
\author{刘羽}
\advisor{侯旭 教授}
\major{人工智能}
\submitdate{2026年4月}
