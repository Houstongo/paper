...
\title{面向碳纳米管阵列的知识增强形貌表征与工艺—形貌关系分析研究}
\entitle{Research on Knowledge-Enhanced Morphology Characterization and Process-Morphology Relationship Analysis for Carbon Nanotube Arrays}
\author{刘羽}
\advisor{侯旭 教授}
\major{人工智能}
\submitdate{2026年4月}
