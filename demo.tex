...
\title[面向碳纳米管阵列的自动化形貌表征与知识增强工艺—形貌关系分析]{面向碳纳米管阵列的自动化形貌表征与\\知识增强工艺—形貌关系分析}
\entitle{Research on Automated Morphology Characterization and Knowledge-Enhanced Process-Morphology Relationship Analysis for Carbon Nanotube Arrays}
\author{刘羽}
\advisor{侯旭 教授}
\major{人工智能}
\submitdate{2026年4月}
